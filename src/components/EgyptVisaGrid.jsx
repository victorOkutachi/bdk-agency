  ...
  return (
    <section id="services" className="py-12 bg-gray-100">
      <div className="container mx-auto px-4">
        ...
        <button className="text-[#ff822e] font-bold hover:text-white border-2 border-[#ff822e] hover:bg-[#ff822e] hover:border-white px-6 py-2 mt-16 mx-auto flex items-center" onClick={() => handleWhatsAppClick(true)}>
        Contact Us Now
        </button>
